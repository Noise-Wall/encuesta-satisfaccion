...
import FormPregunta from "../../components/admin/formPregunta.vue";
import FormEncuesta from "../../components/admin/formEncuesta.vue";
...
async function insertarData() {
  ...
  if (route.params.categoria === "usuarios") {
    ...
    if (res > 300) { createPopup("La contraseña anterior no es válida."); return }
...
async function validarContrasena(data) {
  ...
  if (confirmar !== data.contrasena) createPopup("Las contraseñas no son iguales.")
  else result = 202;
