...
router.get("/group/:id", headerAuthorization, respuestaController.getByEncuesta);
...
router.delete("/delete/group/:id", headerAuthorization, respuestaController.deleteByEncuesta);
